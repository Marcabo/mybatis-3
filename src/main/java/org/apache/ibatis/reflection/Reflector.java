 ...
 * 这个类会缓存反射所需要的类的信息, 例如: 构造方法, 属性名, setting/getting 方法等.
 *
...
public class Reflector {
  ...
  private void addGetMethods(Class<?> clazz) {
    ...
    // 遍历找出方法名是 getXX 和 isXX 的方法名,然后添加到 conflictingGetters 中
  ...
  private void resolveGetterConflicts(Map<String, List<Method>> conflictingGetters) {
    // 遍历每个属性, 查找其最匹配的方法, 因为子类可以覆写父类的方法, 所以一个属性可能对应多个 getting 方法
  ...
  private void addUniqueMethods(Map<String, Method> uniqueMethods, Method[] methods) {
    for (Method currentMethod : methods) {
      if (!currentMethod.isBridge()) { // 忽略所有 Bridge 方法,详见 https://www.zhihu.com/question/54895701/answer/141623158
        // 获得方法签名
